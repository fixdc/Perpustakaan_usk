                ...
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>    
                        ...
                        <tr class="bg-white dark:bg-gray-800">
                            ...
                            <td class="px-6 py-4">
                               {{ $anggota->f_tempatlahir }}
                            </td>
                            <td class="px-6 py-4">
                               {{ $anggota->f_tanggallahir }}
                            </td>
                            <td class="px-6 py-4 flex flex-row gap-3 items-center">
                                <a href="{{ route('editview', ['f_username' => $anggota->f_username]) }}" class="bg-yellow-300 p-2 px-4 rounded-md text-white">Edit</a>
                            
                                <form action="{{ route('delete', ['f_id' => $anggota->f_id]) }}" method="post">
                                    @csrf
                                    @method('delete')
