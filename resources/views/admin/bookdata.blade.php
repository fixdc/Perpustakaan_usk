...
<div class="p-4 sm:ml-64 h-full ">
    <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 h-screen">
        <div class="flex flex-row gap-4">
            <div class="p-5 flex items-center justify-center rounded bg-blue-400 dark:bg-gray-800 hover:bg-blue-800 mb-5">
                <a href="/dashboard/book/add" >
            ...
            <div>
                ...
                <div id="alert-3"
                    ...
                    <span class="sr-only">Info</span>
                    <div class="ms-3 text-sm font-medium">
                        Buku tidak dapat di hapus (Buku ini Sedang Di pinjam)
                    </div>
                    <button type="button"
                        class="ms-auto -mx-1.5 -my-1.5 bg-red-50 text-red-500 rounded-lg focus:ring-2 focus:ring-red-400 p-1.5 hover:bg-red-200 inline-flex items-center justify-center h-8 w-8 dark:bg-gray-800 dark:text-red-400 dark:hover:bg-gray-700"
                        data-dismiss-target="#alert-3" aria-label="Close">
                ...
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>    
                        ...
                        <tr class="bg-white dark:bg-gray-800">
                            ...
                            <td class="px-6 py-4">
                                {{ $book->detailbuku->f_status }}
                            </td>
                            <td class="px-6 py-4 flex flex-row gap-3 items-center">
                                <a href="{{ route('editbook', [ 'f_id' => $book->f_id ]) }}" class="bg-yellow-300 p-2 px-4 rounded-md text-white">Edit</a>
                            
                            
                                <form action="{{ route('deletebook', [ 'f_id'=> $book->f_id]) }}" method="post">
                                    @csrf
                                    @method('delete')
                                    <button type="submit" onclick="return confirm('Apakah anda ingin menghapus buku ini')"  class="bg-red-400 p-2 px-4 rounded-md text-white">Hapus</button>
                                </form>
                            </td>
                        </tr>
                        @endforeach
