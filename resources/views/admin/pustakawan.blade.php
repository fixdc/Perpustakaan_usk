    ...
    <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 h-screen">
        <div class="flex gap-4 mb-4">
            <div class="p-5 flex items-center justify-center rounded bg-blue-400 dark:bg-gray-800 hover:bg-blue-800">
                <a href="/dashboard/pustakawan/create" >
            ...
            <div>
                ...
                <div id="alert-3"
                    ...
                    <div class="ms-3 text-sm font-medium">
                        Berhasil Menambahkan Pustakawan/Admin
                    </div>
                    <button type="button"
                ...
                <div id="alert-3"
                    ...
                    <span class="sr-only">Info</span>
                    <div class="ms-3 text-sm font-medium">
                        Pustakawan/Admin Berhasil Di Delete
                    </div>
                    <button type="button"
                ...
                <div id="alert-3"
                    ...
                    <span class="sr-only">Info</span>
                    <div class="ms-3 text-sm font-medium">
                        Admin/Pustakawan Sedang Bertugas
                    </div>
                    <button type="button"
                        class="ms-auto -mx-1.5 -my-1.5 bg-red-50 text-red-500 rounded-lg focus:ring-2 focus:ring-red-400 p-1.5 hover:bg-red-200 inline-flex items-center justify-center h-8 w-8 dark:bg-gray-800 dark:text-red-400 dark:hover:bg-gray-700"
                        data-dismiss-target="#alert-3" aria-label="Close">
                ...
                <div id="alert-3"
                    ...
                    <span class="sr-only">Info</span>
                    <div class="ms-3 text-sm font-medium">
                        Data Pustakawan/Admin berhasil diedit
                    </div>
                    <button type="button"
                    ...
                    <tbody>    
                        ...
                        <tr class="bg-white dark:bg-gray-800">
                            ...
                            <td class="px-6 py-4 flex flex-row gap-3 items-center">
                                <a href="{{ route('editviewadmin', ['f_username' => $admin->f_username]) }}" class="bg-yellow-300 p-2 px-4 rounded-md text-white">Edit</a>
                            

                                <form action="{{ route('deleteadmin', ['f_id' => $admin->f_id]) }}" method="POST">
                                    @csrf
                                    @method('delete')
                                    <button type="submit" class="bg-red-400 p-2 px-4 rounded-md text-white">Delete</button>
                                </form>
                            </td>
                        </tr>
                        @endforeach
