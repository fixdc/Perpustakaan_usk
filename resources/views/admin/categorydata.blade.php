        ...
        <div class="flex gap-4 mb-4">
            ...
            <div>
                ...
                <div id="alert-3"
                    ...
                    <span class="sr-only">Info</span>
                    <div class="ms-3 text-sm font-medium">
                        Kategori tidak dapat di hapus (Kategori ini Memiliki Buku)
                    </div>
                    <button type="button"
                        class="ms-auto -mx-1.5 -my-1.5 bg-red-50 text-red-500 rounded-lg focus:ring-2 focus:ring-red-400 p-1.5 hover:bg-red-200 inline-flex items-center justify-center h-8 w-8 dark:bg-gray-800 dark:text-red-400 dark:hover:bg-gray-700"
                        data-dismiss-target="#alert-3" aria-label="Close">
                    ...
                    <tbody>    
                        ...
                        <tr class="bg-white dark:bg-gray-800">
                            ...
                            <td class="px-6 py-4 flex flex-row gap-3 items-center">
                                <a href="{{ route('editcategory', [ 'f_id' => $kategori->f_id ]) }}" class="bg-yellow-300 p-2 px-4 rounded-md text-white">Edit</a>
                            
                                <form action="{{ route('deletecategory', [ 'f_id'=> $kategori->f_id]) }}" method="post">
                                    @csrf
                                    @method('delete')
                                    <button type="submit" class="bg-red-400 p-2 px-4 rounded-md text-white">Hapus</button>
                                </form>
                            </td>
                        </tr>
                        @endforeach
