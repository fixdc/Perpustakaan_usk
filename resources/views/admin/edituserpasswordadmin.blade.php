...
<div class="h-full ">
    <div class="p-4 sm:ml-64 h-full">
        <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 h-screen">
            ...
            <form class="mx-auto max-w-5xl flex flex-col justify-start text-white" action="{{ route('editpasswordadmin', [$admin->f_username]) }}" method="POST" >
                @csrf
                <div class="mb-5 font-Mont font-bold">
                    <label  class="block font-bold mb-2 text-sm text-black">Password</label>
                    <input type="text" id="name" name="f_password"
