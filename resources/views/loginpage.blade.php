    ...
    <div class="container relative m-auto px-6 text-gray-500 md:px-12 xl:px-40">
      <div class="m-auto space-y-8 md:w-8/12 lg:w-6/12 xl:w-6/12">
        <div class="rounded-3xl border border-gray-100 bg-white dark:bg-gray-800 dark:border-gray-700 shadow-2xl shadow-gray-600/10 backdrop-blur-2xl">
            <a href="/" class="bg-blue-400 p-4 md:p-5 rounded-md text-white -ml-3 md:-ml-10 -mb-5">Back to homepage</a>
        ...
        @endif
            ...
            <form action="/login" method="POST" class="space-y-8">
              ...
              <button type="submit" class="relative flex h-11 w-full items-center justify-center px-6 before:absolute before:inset-0 before:rounded-full before:transition before:duration-300 hover:before:scale-105 active:duration-75 active:before:scale-95 bg-blue-400 rounded-md">
                <span class="relative text-base font-semibold text-white dark:text-dark">Connect</span>
              </button>
              
            </form>
            <div class="pt-5">
              <h2 class="text-red-500 font-cool">*catatan : login untuk anggota</h2>
              <h2 class="text-red-500 font-cool">*bukan anggota?<a href="/loginadmin" class="underline pl-1">Klik Disini</a></h2>
            </div>
          </div>
        </div>
      </div>
